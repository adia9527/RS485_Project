...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, RS4852_DIR_Pin|LCD_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, W25Q64_CS_Pin|LCD_CS_Pin|LCD_RST_Pin|LCD_BL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : RS4852_DIR_Pin W25Q64_CS_Pin LCD_RST_Pin */
  GPIO_InitStruct.Pin = RS4852_DIR_Pin|W25Q64_CS_Pin|LCD_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : RS4851_DIR_Pin */
  GPIO_InitStruct.Pin = RS4851_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(RS4851_DIR_GPIO_Port, &GPIO_InitStruct);
